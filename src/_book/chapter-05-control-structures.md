...
Go? Для этого существует оператор `%`. `1 % 2` равно `1`, `2 % 2` равно `0`, `3
% 2` равно `1`, и так далее.

Далее нам нужен способ выполнять действия в зависимости от условия. Для этого мы
...
Если они оказываются равны, выполняется действие, описанное после `:`.
