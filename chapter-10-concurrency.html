...
<div class="prevnext">
    ...
    <div class="prevnext_item -prev">&larr; <a href="/chapter-09-structs-and-interfaces.html">Структуры и интерфейсы</a></div>
  

  
    <div class="prevnext_item -next"><a href="/chapter-11-packages.html">Пакеты и повторное использование кода</a> &rarr;</div>
